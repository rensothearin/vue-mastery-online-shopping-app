            ...
            <div>
              ...
              <div>
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                  <button
                    class="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10"
                  >
                    <svg
                      width="20"
                      height="20"
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <router-link
                        to="/reset-password"
                        class="text-sm text-indigo-500 hover:text-indigo-600 dark:text-indigo-400"
                ...
                <div class="mt-5">
                  ...
                  >
                    ...
                    <router-link
                      to="/signup"
                      class="text-indigo-500 hover:text-brand-600 dark:text-indigo-400"
                      >Sign Up</router-link
                    >
                  </p>
                </div>
        ...
        >
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <router-link to="/" class="block mb-4 h-auto lg:h-1/2 lg:w-1/2 max-w-2xl p-6 text-center w-auto">
